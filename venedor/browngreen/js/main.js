...
(function ($) {
	...
	var Venedor = {
		...
		owlCarousels: function () {
		    ...
		    /* Home Page Popular Product- latest-items carousel */
			var  popularItems = $('.popular-items-slider.owl-carousel');
			if (self.checkSupport(popularItems, $.fn.owlCarousel)) {
		        popularItems.owlCarousel({
		            ...
		            mouseDrag: false,
		            autoHeight : true
		        }).data('navigationBtns', ['#popular-items-slider-prev', '#popular-items-slider-next']);
		    }
		...
		parallax: function () {
			...
			if (!Venedor.mobile && $.fn.parallax) {
				...
				$('#funfact-section').addClass('parallax').parallax("f0%", 0.4);
			}

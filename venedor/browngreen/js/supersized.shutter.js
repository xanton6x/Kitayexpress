		...
		----------------------------*/
	 	_init : function(){
			...
			if (api.options.thumb_links){
        		...
        		$(vars.thumb_forward).on('click', function(){
        			if (vars.thumb_page - vars.thumb_interval <= -$(vars.thumb_list).width()){
        				vars.thumb_page = 0;
        				$(vars.thumb_list).stop().animate({'left': vars.thumb_page}, {duration:500});
        			}else{
        		...
        		$(vars.thumb_back).on('click', function(){
				...
				$(vars.thumb_tray).mousemove(function(e) {
					...
					if (listWidth > containerWidth){
						...
						if (diff > 10 || diff < -10) { 
						    ...
						    $(vars.thumb_list).stop().animate({'left':newX}, {duration:diff*3});
						}
					}
				});
			}
